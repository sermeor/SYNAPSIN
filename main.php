...
<!-- MAin logo -->
  <div class="w3-display-container w3-center">
    <img src="/images/main_fig4.png" style="width:102%; transform: translateX(-1%);">
  ...
  <div class="w3-black" id="manifesto">
    <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px">
      ...
      <p class="w3-justify">SYNAPSIN is for the people. We will cluster in one unique brand record label, promoter and booking agent with one unique purpose: to catapult emerging talents to their success.</p>
    </div>
  </div>
  ...
  <div class="mySlides fade w3-display-container w3-center">
    ...
    <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
      <p><b>SYNAPSIN II, BOAT LIVE, London (12/03/2022)</b></p>
    </div>
  </div>
  <div class="mySlides fade w3-display-container w3-center">
  ...
  <div class="mySlides fade w3-display-container w3-center">
    ...
    <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
      <p><b>SYNAPSIN I, The Cause, London (16/11/2021)</b></p>
    </div>
  </div>
  <div class="mySlides fade w3-display-container w3-center">
      ...
      <div class="w3-row-padding w3-padding-32" style="margin:0 -16px">
        <div class="w3-third w3-margin-bottom">
          ...
          <div class="w3-container w3-white">
            <p><b>Synapsin II, Boat Live, London </b></p>
            <p class="w3-opacity">Sat 12th Mar, 2022</p>
            <p>Past event.</p>
          </div>
        </div>
        <div class="w3-third w3-margin-bottom">
          ...
          <div class="w3-container w3-white">
            <p><b>Synapsin I, The Cause, London</b></p>
            <p class="w3-opacity">Friday 16th Nov, 2021</p>
            <p>Past event.</p>
          </div>
        </div>
      </div>
  ...
  <div class="w3-black" id="opportunities">
    <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px">
      <h1 class="w3-wide w3-center" style="color:yellow;">OPPORTUNITIES</h1>
  ...
  <div class="w3-black" id="contact">
    <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px">
      ...
      <div class="w3-row w3-padding-32 w3-center">
        ...
        <p class="w3-center"><i class="fa fa-phone" style="width:30px"></i> Phone: +44 (0) 7592 229399<br></p>
        <p class="w3-center"><i class="fa fa-envelope" style="width:30px"> </i> Email: hello@synapsin.co.uk<br></p>
      </div>
  </div>
...
<footer class="w3-container w3-padding-64 w3-center w3-opacity w3-light-grey w3-xlarge">
  <a href="mailto:hello@synapsin.co.uk"><i class="fa fa-envelope"></i></a>
  <a href="https://www.instagram.com/synapsin.official/"><i class="fa fa-instagram w3-hover-opacity"></i></a>
</footer>
